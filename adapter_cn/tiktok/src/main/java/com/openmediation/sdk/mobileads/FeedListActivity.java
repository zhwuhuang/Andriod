    ...
    private void loadListAd() {
        ...
        mTTAdNative.loadFeedAd(adSlot, new TTAdNative.FeedAdListener() {
            ...
            public void onError(int code, String message) {
                ...
                TToast.show(com.union_test.toutiao.activity.FeedListActivity.this, message);
            }
            ...
            public void onFeedAdLoad(List<TTFeedAd> ads) {
                ...
                if (ads == null || ads.isEmpty()) {
                    TToast.show(com.union_test.toutiao.activity.FeedListActivity.this, "on FeedAdLoaded: ad is null!");
                    return;
                }
                ...
                for (TTFeedAd ad : ads) {
                    ad.setActivityForDownloadApp(com.union_test.toutiao.activity.FeedListActivity.this);
